...
def calculate_stats(profile_db_location:str, profile_name:str):
    ...
    stats['min_generation'] = int(session.query(func.min(table.c.generation)).scalar()),
    stats['max_generation'] = int(session.query(func.max(table.c.generation)).scalar()),
    ...
    stats['min_consumption'] = int(session.query(func.min(table.c.consumption)).scalar()),
    stats['max_consumption'] = int(session.query(func.max(table.c.consumption)).scalar()),
